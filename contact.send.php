<?php
	...
	$send_name      = "Imagine Hacks";		// Replace your name
	$send_title     = "Imagine Hacks Register";		// Replace email sent title
	$send_address   = "bibin@imaginehacks.com";	// Replace your email address
